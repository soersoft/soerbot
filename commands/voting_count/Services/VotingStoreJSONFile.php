...
namespace SoerBot\Commands\Voting_count\Services;

use SoerBot\Commands\Voting_count\Interfaces\VotingStoreInterface;

/**
 * Class VotingStoreJSONFile.
 *
 * @package SoerBot\Commands\Voting_count\Services
 */
class VotingStoreJSONFile implements VotingStoreInterface
{
    ...
    {
        array_push($this->data, ['count' => $args[0]]);
